...
def scaffold(ep: Path) -> int:
    ...
    out = [
        f"# {ep.name}｜出图台账",
        "",
        f"规范见 [`../../../doc/13_出图工序规范.md`](../../../doc/13_出图工序规范.md)。",
...
def main() -> int:
    ap = argparse.ArgumentParser(description="出图台账闸门（doc/13_出图工序规范.md）")
